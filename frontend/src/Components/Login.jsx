...
function Login(){
  ...
  <div className="relative min-h-screen w-full">
    ...
    {/* Form */}
    <div className="relative flex items-center justify-center min-h-screen z-10 text-white">
      <form
        onSubmit={(e) => e.preventDefault()}
        className="w-3/12 bg-black/60 p-8 rounded"
      >
        ...
        {!isSignInForm && (
          <input
            ...
            className="p-4 my-4 w-full border border-gray-700 rounded"
          />
        )}
        <input
          ref={email}
